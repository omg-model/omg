...
outdir = '~/GitHub/omg/output/OMG_output_2023-07-10_Run_0001';
...
%% plot frames timestep by timestep
...
for t=1:ntime
    ...
    PHY_p = permute(PHY(:,:,:,:,t),[2 4 1 3]);
    % combine size+lon (rows) and troph+lat (columns)
    PHY_a = reshape(PHY_p,nlat*nT2,nlon*nT1);    
